...
const Header = () => {
  ...
  const renderAuthButtons = () => {
    if (localStorage.getItem("login") === "1") {
      return (
        <>
          <Link to="/user-profile" type="button" className="btn ms-3 btn-primary">
      ...
      <nav className="navbar navbar-expand-lg navbar-light border-bottom py-2">
        <div className="container text-center">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form className="d-flex gap-1" onSubmit={onSearch}>
              <input className="form-control" type="search" placeholder="Search" aria-label="Search" value={searchKeyword} onChange={(e) => setSearchKeyword(e.target.value)} />
